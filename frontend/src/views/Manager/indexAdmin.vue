...
const quickAccessItems = [
  ...
  { icon: '👥', label: '物业人员管理', path: '/admin/StaffAdmin' },
  { icon: '💰', label: '统一定价', path: '/admin/FeeTypeAdmin' },
  { icon: '📜', label: '规章制度', path: '/admin/RegulationAdmin' },
  { icon: '🔧', label: '设备台账', path: '/admin/EquipmentAdmin' }
];
